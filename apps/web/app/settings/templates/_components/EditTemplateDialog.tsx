...
/**
 * "Edit Template" dialog — wraps TemplateForm in a Dialog modal.
 * Replaces the standalone /settings/templates/[id] subpage.
 */
...
import type { TemplateRow } from '../_lib/templates-repo'
...
export function EditTemplateDialog({ row }: Props) {
