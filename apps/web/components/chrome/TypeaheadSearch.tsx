 ...
 *   - Matching creators appear first in a "Creators" group; articles below in an
 *     "Articles" group.
...
import type { TypeaheadArticle, TypeaheadCreator } from '@/app/api/search/typeahead/route'
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
export function TypeaheadSearch() {
  ...
  const hasResults = articles.length > 0 || creators.length > 0
          ...
          <PopoverTrigger asChild>
            <div className="relative">
              ...
              <Input
                ...
                className="w-40 pl-8 pr-2 md:w-52 h-9"
              />
            </div>
          </PopoverTrigger>
        </form>
